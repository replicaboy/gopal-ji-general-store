...
const Inventory = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get('https://ubiquitous-space-tribble-pj9vjqqr9jwph66r6-5000.app.github.dev/api/products');
  ...
  const handleAddProduct = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://ubiquitous-space-tribble-pj9vjqqr9jwph66r6-5000.app.github.dev/api/products/add', newProduct);
